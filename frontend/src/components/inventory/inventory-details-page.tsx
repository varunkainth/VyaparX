...
export function InventoryDetailsPage({ itemId }: InventoryDetailsPageProps) {
  ...
  const onAdjustStock = async (data: AdjustStockFormData) => {
    ...
    try {
      ...
      stockForm.reset();
      toast.success(
        `Stock ${data.direction === "in" ? "added" : "removed"} successfully!`,
      );
    } catch (error) {
      const errorMessage = getErrorMessage(error);
      toast.error(errorMessage);
          ...
          <div className="flex flex-1 flex-col gap-4 md:gap-6 p-4 md:p-6 pb-20 md:pb-6">
                  ...
                  <>
                    ...
                    >
                      ...
                      <AlertDialogContent className="max-w-[95vw] sm:max-w-lg">
                        ...
                        <form
                          onSubmit={stockForm.handleSubmit(onAdjustStock)}
                          className="space-y-4"
                        >
                          <Field>
            ...
            <div className="grid gap-3 md:gap-4 grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <div
                    className={`text-lg sm:text-xl md:text-2xl font-bold ${isLowStock ? "text-orange-600" : ""}`}
                  >
            ...
            {!canCreateEdit && (
              <Alert>
                ...
                <AlertDescription>
                  Your role has read-only access for inventory items.
                </AlertDescription>
              </Alert>
            )}
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This will permanently delete "{item.name}" and
