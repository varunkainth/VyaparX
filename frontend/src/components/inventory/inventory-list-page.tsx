...
export function InventoryListPage() {
  ...
  const calculateTotalValue = () => {
    return items.reduce(
      (sum, item) => sum + item.current_stock * item.selling_price,
      0,
    );
  };
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <EmptyState
                    ...
                    action={
                      searchQuery || showLowStock || !canCreateEdit
                        ? undefined
                        : {
                            label: "Add Item",
                            onClick: () => router.push("/inventory/create"),
                      ...
                      {filteredItems.map((item) => (
                        ...
                        >
                          ...
                          <div className="text-right space-y-1 flex-shrink-0">
                            ...
                            <p
                              className={`font-semibold text-lg ${item.current_stock < item.low_stock_threshold ? "text-orange-600" : ""}`}
                            >
                      ...
                      {filteredItems.map((item) => (
                        ...
                        >
                          ...
                          <MobileTableCell label="Stock">
                            <span
                              className={`font-semibold ${item.current_stock < item.low_stock_threshold ? "text-orange-600" : ""}`}
                            >
                              {item.current_stock} {item.unit}
                            </span>
                          </MobileTableCell>
