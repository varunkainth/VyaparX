...
export function ProfilePage() {
  ...
  const handleResendVerification = async () => {
    const VERIFICATION_RESEND_COOLDOWN_MS = 300_000;
    ...
    try {
      ...
      if (error instanceof AxiosError && error.response?.status === 429) {
        toast.error("You can resend the verification email after 300 seconds.");
        return;
      }
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col gap-3">
                        <Button
                          ...
                          disabled={
                            isResendingVerification || verificationEmailSent
                          }
                          variant="outline"
              ...
              <Card className="md:col-span-2">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          Use your device or security key to sign in without
                          typing a password
                        </CardDescription>
                      </div>
                    </div>
                ...
                <CardContent className="space-y-4">
                  {!passkeyClient.isSupported() ? (
                    ...
                    <p className="text-sm text-muted-foreground">
                      No passkeys registered yet. Add one to sign in faster and
                      reduce password use.
                    </p>
                  ) : (
                      ...
                      {passkeys.map((credential) => (
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              {credential.credential_device_type ===
                              "multiDevice"
                                ? "Synced passkey"
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleDeletePasskey(credential.credential_id)
                            }
                            disabled={
                              deletingCredentialId === credential.credential_id
                            }
                          >
