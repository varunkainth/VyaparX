    ...
    try {
      ...
      toast.success(
        result.email_sent
          ...
          : "Invite created. Share the link manually if email is unavailable.",
      );
      reset();
      setSelectedRole("viewer");
      onSuccess();
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[550px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Send an invitation link for a user to join this business. They can
            sign up or sign in, then accept it.
          </DialogDescription>
        </DialogHeader>
          ...
          <FieldGroup>
            ...
            <Field className="mt-4">
              ...
              <NativeSelect
                ...
                disabled={isSubmitting}
                onChange={(e) =>
                  setSelectedRole(e.target.value as BusinessRole)
                }
              >
              ...
              <FieldDescription className="text-xs mt-1">
                Owners cannot be assigned. Owners must transfer ownership
                manually.
              </FieldDescription>
            </Field>
          </FieldGroup>
