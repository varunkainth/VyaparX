...
import { createPartySchema, type CreatePartyFormData } from "@/validators/party.validator"
        ...
        <div className="flex flex-1 flex-col gap-4 md:gap-6 p-4 md:p-6 pb-20 md:pb-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight">Create Party</h1>
                <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1">
                  <span className="hidden sm:inline">Add a new customer or supplier</span>
                  <span className="sm:hidden">Add customer/supplier</span>
                </p>
              </div>
            </div>
            <Button variant="outline" onClick={() => router.push("/parties")} className="cursor-pointer hidden sm:flex">
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <CardTitle className="text-base md:text-lg">Opening Balance</CardTitle>
                      <CardDescription className="text-xs md:text-sm">Initial balance for this party</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <FieldGroup>
                    <div className="grid gap-3 md:gap-4 sm:grid-cols-2">
                      <Field>
                        <FieldLabel htmlFor="opening_balance_type" className="text-xs md:text-sm">Balance Type</FieldLabel>
                        <Select
                          value={openingBalanceType}
                          onValueChange={(value) => setValue("opening_balance_type", value as "receivable" | "payable" | "none")}
                          disabled={isSubmitting}
                        >
                          <SelectTrigger className="w-full">
                      ...
                      {openingBalanceType !== "none" && (
                        <Field>
                          <FieldLabel htmlFor="opening_balance" className="text-xs md:text-sm">Amount</FieldLabel>
                          <Input
                            id="opening_balance"
                            type="number"
                            step="0.01"
                    ...
                    <Field>
                      <FieldLabel htmlFor="notes" className="text-xs md:text-sm">Notes</FieldLabel>
                      <Textarea
                        id="notes"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm text-muted-foreground">
                        <span className="hidden sm:inline">Add this party to your business</span>
