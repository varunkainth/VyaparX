...
export function InvoiceSettingsPage() {
  ...
  const onSubmit = async (data: UpdateInvoiceSettingsInput) => {
    ...
    setIsSaving(true);
    try {
      const updated = await invoiceSettingsService.updateSettings(
        currentBusiness.id,
        data,
      );
      setSettings(updated);
  ...
  const handleResetToDefaults = async () => {
    ...
    setIsResetting(true);
    try {
      const defaults = await invoiceSettingsService.resetToDefaults(
        currentBusiness.id,
      );
        ...
        <div className="flex min-h-screen items-center justify-center p-4">
          <Card className="w-full max-w-lg">
            <CardHeader>
              ...
              <CardDescription>
                Only owner and admin accounts can manage invoice settings.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
              ...
              <FieldGroup>
                <div className="grid gap-3 md:gap-4 md:grid-cols-2">
                  ...
                  <Field>
                    ...
                    <Input {...register("purchase_prefix")} placeholder="PUR" />
                    <p className="text-xs text-muted-foreground mt-1">
                ...
                <div className="grid gap-3 md:gap-4 md:grid-cols-2">
                  ...
                  <Field>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setValue("default_template", value, {
                          shouldDirty: true,
                        })
                      }
                    >
            ...
            <CardHeader>
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-xs md:text-sm">
                    Configure tax display and labels
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("enable_tax", checked, { shouldDirty: true })
                      }
                    />
                  </div>
                      ...
                      <div className="grid gap-3 md:gap-4 md:grid-cols-2">
                        ...
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked: boolean) =>
                              setValue("show_tax_number", checked, {
                                shouldDirty: true,
                              })
                            }
                          />
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("show_logo", checked, { shouldDirty: true })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("show_signature", checked, {
                          shouldDirty: true,
                        })
                      }
                    />
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("show_terms", checked, { shouldDirty: true })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("show_notes", checked, { shouldDirty: true })
                      }
                    />
                  </div>
              ...
              <FieldGroup>
                <div className="space-y-3 md:space-y-4">
                  <Field>
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      Variables: {"{invoice_number}"}, {"{business_name}"},{" "}
                      {"{amount}"}
                    </p>
                  </Field>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("auto_send_email", checked, {
                          shouldDirty: true,
                        })
                      }
                    />
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked: boolean) =>
                        setValue("enable_online_payment", checked, {
                          shouldDirty: true,
                        })
                      }
                    />
