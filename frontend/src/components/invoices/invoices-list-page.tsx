...
export function InvoicesListPage() {
  ...
  const [lifecycleFilter, setLifecycleFilter] = useState<
    "all" | "finalized" | "revised" | "cancelled"
  >("all");
  ...
  const filterInvoices = () => {
    ...
    if (invoiceTypeFilter !== "all") {
      filtered = filtered.filter(
        (invoice) => invoice.invoice_type === invoiceTypeFilter,
      );
    }
    ...
    if (paymentStatusFilter !== "all") {
      filtered = filtered.filter(
        (invoice) => invoice.payment_status === paymentStatusFilter,
      );
    }
    ...
    if (lifecycleFilter !== "all") {
      filtered = filtered.filter((invoice) => {
        ...
        if (lifecycleFilter === "revised")
          return !!invoice.reference_invoice_id;
  ...
  const getUnpaidCount = () => {
    return invoices.filter(
      (i) => i.payment_status === "unpaid" && !i.is_cancelled,
    ).length;
  };

  const getOverdueCount = () => {
    return invoices.filter(
      (i) => i.payment_status === "overdue" && !i.is_cancelled,
    ).length;
  };
  ...
  const getLifecycleCounts = () => ({
    finalized: invoices.filter(
      (invoice) => !invoice.is_cancelled && !invoice.reference_invoice_id,
    ).length,
    revised: invoices.filter((invoice) => !!invoice.reference_invoice_id)
      .length,
  ...
  const handleReviseInvoice = (invoice: Invoice) => {
    if (
      !currentBusiness ||
      !hasPermission(currentBusiness.role, "createEdit")
    ) {
      toast.error("You do not have permission to revise invoices.");
      return;
    }
        ...
        <PageLayout onRefresh={fetchInvoices}>
          ...
          <div className="flex flex-1 flex-col gap-4 md:gap-6 p-4 md:p-6 pb-20 md:pb-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              {canCreateEdit && (
                <DropdownMenu
                  open={showCreateDropdown}
                  onOpenChange={setShowCreateDropdown}
                >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-xl sm:text-2xl font-bold">
                    {invoices.filter((i) => !i.is_cancelled).length}
                  </div>
                </CardContent>
              </Card>
              <Card>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <span className="ml-2 text-xs text-muted-foreground">
                    Finalized {getLifecycleCounts().finalized} • Revised{" "}
                    {getLifecycleCounts().revised} • Cancelled{" "}
                    {getLifecycleCounts().cancelled}
                  </span>
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    action={
                      ...
                      !canCreateEdit
                        ...
                        : {
                            ...
                            onClick: () =>
                              router.push("/invoices/create/sales"),
                          }
                    }
                    secondaryAction={
                      searchQuery ||
                      ...
                      !canCreateEdit
                        ...
                        : {
                            ...
                            onClick: () =>
                              router.push("/invoices/create/purchase"),
                          }
                    }
                  />
                ) : (
                          ...
                          >
                            <div className="flex items-center gap-4 flex-1 min-w-0">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div
                                  className={`flex items-center gap-4 mt-1 text-sm ${invoice.is_cancelled ? "text-red-600/80 dark:text-red-300/80" : "text-muted-foreground"}`}
                                >
                            ...
                            <div className="flex items-center gap-4 flex-shrink-0">
                              <div className="text-right">
                                <p
                                  className={`font-semibold ${invoice.is_cancelled ? "text-red-700 dark:text-red-300" : ""}`}
                                >
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  {canDelete && !invoice.is_cancelled && (
                                    <>
                                      <DropdownMenuSeparator />
                                      <DropdownMenuItem
                                        onClick={() =>
