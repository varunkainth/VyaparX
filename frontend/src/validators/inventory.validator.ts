...
export const createInventorySchema = z.object({
  ...
  purchase_price: z.number({ error: "Purchase price is required" }).min(0, "Purchase price cannot be negative"),
  selling_price: z.number({ error: "Selling price is required" }).min(0, "Selling price cannot be negative"),
