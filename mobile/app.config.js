...
const iosAssociatedDomains = passkeyDomain
  ? [`webcredentials:${passkeyDomain}`, `applinks:${passkeyDomain}`]
  : [];
...
const config = {
  ...
  plugins: [
    ...
    [
      ...
      {
        photosPermission:
          "Allow VyaparX to access photos and files for attachments and saved documents.",
        savePhotosPermission:
          "Allow VyaparX to save invoices and exported files to your library.",
      },
    ],
  ],
  splash: {
